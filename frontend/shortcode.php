					...
					<?php foreach ( $links as $k => $link ) {
						...
						<div class="wmc-currency <?php echo esc_attr( $class ) ?>">
							<a title="<?php echo esc_attr( $country['name'] ) ?>" href="<?php echo $link ?>">
								<span class="flags flags-<?php echo $country['code']; ?>"><img width="30" height="20"  src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-lazy-type="image" data-src="<?php echo get_template_directory_uri(); ?>/assets/images/flag_<?php echo $country['code']; ?>.png"/></span>
								<span>
